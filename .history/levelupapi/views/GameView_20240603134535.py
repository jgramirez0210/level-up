...
class GameView(ViewSet):
    ...
    def update(self, request, pk):
        ...
        game.number_of_players = int(request.data.get("number_of_players", game.number_of_players))
        game.skill_level = int(request.data.get("skill_level", game.skill_level))
    
        game_type = Game_Type.objects.get(pk=request.data.get("gameType", game.game_type.pk))
